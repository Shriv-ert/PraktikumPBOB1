...
public class Persegi extends BangunDatar implements IResize {
    ...
    @Override
    public void zoomIn() {
        sisi *= 1.1; // memperbesar sisi persegi menjadi 10% dari ukuran awal
    }

    @Override
    public void zoomOut() {
        sisi *= 0.9; // mengurangi sisi persegi menjadi 90% dari ukuran awal
    }

    @Override
    public void zoom(int percent) {
        sisi *= (percent / 100.0); // merubah ukuran sesuai input persentase
    }
