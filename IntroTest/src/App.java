public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // PERBAIKAN: String tidak boleh terpotong baris tanpa escape (\n)
    ...
    // PERBAIKAN: komentar sebelumnya salah format "(if-else)" berada di luar comment
    ...
    public static void contohArrayDanLooping() {
        ...
        // PERBAIKAN: String array sebelumnya terpotong baris tanpa format yang benar
        String[] mataKuliah = {
            "Matematika",
            "Fisika",
            "Pemrograman",
        ...
        // PERBAIKAN: pembagian sebelumnya terpotong baris
        ...
        // PERBAIKAN: sebelumnya tidak ada newline setelah kurung kurawal }
        ...
        // PERBAIKAN: string println sebelumnya terpotong baris
